        ...
        <div className='fleet-container'>
            ...
            <div className='fleet-column2'>
                {/* <section> */}
                  ...
                  Depending on your specific needs, we provide a variety of tracking solutions. Our solutions will provide you a clear, thorough picyure of your fleet, reducing delays and expenses. We provide necessary products and services to help you manage your fleet effectively and efficiently.
                  </p>
                {/* </section> */}
            </div>
        </div>
