                ...
                <DigitalRows imgStart={imgStart}>
                    <Column1>
                        <DigitalText>
                            ...
                            <Heading  lightText={lightText}>Advanced Agile and other SDLC (Software Development Life Cycle) Methodologies, Cyber Security, Cloud Computing, Design thinking/Product Development Labs, and others are among our digital technology strengths.</Heading>
