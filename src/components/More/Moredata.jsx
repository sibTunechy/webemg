export const moreData = {
    ...
    Heading2: 'EXECUTION',
    Heading3: 'ENTERPRISE',
    Paragraph: 'We create personalized, customer-centric experiences, the right technology and people with our solutions deployed across various channels to suit the demography of the target market and analyze the data from our two-way engagement with the market for the strategic use of clients.',
